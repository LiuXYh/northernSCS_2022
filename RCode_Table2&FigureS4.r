...
for(i in 1:length(sub_graph)){
	...
	Degree <- c(Degree, mean(degree1(sub_graph[[i]])))  #degree
	...
	complementarity  <- c(complementarity , sum(compute.brlen(tree_i)$edge.length))
}
...
# Kruskal-Wallis test
kw <- kruskal(env$nodes_num, env$watermass, p.adj = 'BH')
kw$groups
kw <- kruskal(env$edges_num, env$watermass, p.adj = 'BH')
kw$groups
kw <- kruskal(env$degree, env$watermass, p.adj = 'BH')
kw$groups
kw <- kruskal(env$pos_cohesion, env$watermass, p.adj = 'BH')
kw$groups
kw <- kruskal(env$pos_neg_cohesion, env$watermass, p.adj = 'BH')
kw$groups
kw <- kruskal(env$clustering_coefficient, env$watermass, p.adj = 'BH')
kw$groups
kw <- kruskal(env$modularity, env$watermass, p.adj = 'BH')
kw$groups
kw <- kruskal(env$complementarity, env$watermass, p.adj = 'BH')
kw$groups
